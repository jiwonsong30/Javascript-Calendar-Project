...
function loginPage(event) {
	...
	document.getElementsByClassName("user")[0].appendChild(document.createElement("br"));
	document.getElementsByClassName("user")[0].appendChild(document.createElement("br"));
	document.getElementsByClassName("user")[0].appendChild(document.createTextNode("Don't have an account yet? Fill out username, password, and email. Then click Register.\n	"));
	document.getElementsByClassName("user")[0].appendChild(document.createElement("br"));	
	...
	var displayed_month = "             Calendar: "+month_display+"/"+year_display;
	...
	document.getElementsByClassName("creative")[0].appendChild(document.createTextNode(" Want to share your calendar with another user? "));
	document.getElementsByClassName("creative")[0].appendChild(document.createElement("br"));
	document.getElementsByClassName("creative")[0].appendChild(document.createTextNode(" His/Her username: "));
	...
	xmlHttp.addEventListener("load", function(event) {
    	   var jsonData = JSON.parse(event.target.responseText); 
		    ...
		    window.location.replace("http://ec2-54-68-130-119.us-west-2.compute.amazonaws.com/~jiwonsong/calendar.php");
	    }else{
                    alert("Something wrong  "+jsonData.message);
            }
        }, false);
